...
# -*- coding: utf-8 -*-
"""
Example usage of fmpfit_f64 extension - Minimal data case
...
Run N times with different noise realizations using float64 precision.

Usage:
    python example_fmpfit_f64_5_N.py [N]
...
print("=" * 70)
print(f"FMPFIT FLOAT64 Minimal Data Example: 5 pixels, {N} runs")
print("=" * 70)
