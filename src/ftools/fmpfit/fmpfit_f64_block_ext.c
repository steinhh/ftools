...
/*
 * Python wrapper: fmpfit_f64_block(x, y, error, p0, bounds, n_spectra, mpoints, npar,
 *                                   deviate_type, xtol, ftol, gtol, maxiter, quiet)
 *
